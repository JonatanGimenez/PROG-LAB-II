...
namespace Test.Eventos.WF
{
    public partial class frmJuego : Form
    {
        ...
        private void InicializarManejadoresDeEventos()
        {
            ...
            this._juego.Proximo += new Proximidad(metodoProximo);
        }
        ...
        private void txtNumero_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                this.lblPista.Text = "Pista: " + this._juego.Pista;
            }
        ...
        private void metodoProximo(int dato)
        {
            MessageBox.Show("El numero ingresado es: " + dato);
        }

        private void Ganaste(object obj, EventArgs e)
        {
            this.lblIntentos.Text = "Intentos " + this._juego.CantidadIntentos + " / " + this._juego.intentosMaximo.ToString();
        ...
        private void SeguiParticipando(object obj, EventArgs e)
        {
            ...
            MessageBox.Show("Pista: " + this._juego.Pista + "\nSeguir intentando?");
        }
